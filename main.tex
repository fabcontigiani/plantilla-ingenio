...
\section*{\small Símbolos}

\begin{figure}[htbp]
    \begin{tblr}{
    colspec={| Q[c,m] X[l,m] | Q[c,m] X[l,m] |},
    width=\linewidth,
    hline{1,Z} = {solid},
}
$S$ & Potencia aparente (TNR10) & $V_f$ & Volumen final (\si{\litre}) \\
$V_o$ & Tensión controlada de salida (unidades) & $P_p$ & Presión parcial (\si{atm}) \\
$V_i$ & Volumen inicial (\si{\litre}) & $T_a$ & Temperatura absoluta (\si{\kelvin}) \\
$\dots$ & \dotfill & $\dots$ & \dotfill \\
\end{tblr}
\end{figure}
